...
\input{appendix_v_sql}

\section*{Приложение В. Скрипты создания функций и процедур}
\addcontentsline{toc}{section}{Приложение В. Скрипты создания функций и процедур}
...
\begin{lstlisting}[language=SQL, label=lst:trigger-ddl,
  caption=Отложенный триггер проверки корректности очков]
...
\begin{lstlisting}[language=SQL, label=lst:season-stats-trigger,
  caption=Триггер пересчёта витрины с переходной таблицей]
...
\section*{Приложение Г. Исходный код механизма кэширования}
\addcontentsline{toc}{section}{Приложение Г. Исходный код механизма кэширования}
...
\input{appendix_zh_presentation}
