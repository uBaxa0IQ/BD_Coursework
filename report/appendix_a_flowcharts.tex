\section*{Приложение А. Схемы алгоритмов}
\addcontentsline{toc}{section}{Приложение А. Схемы алгоритмов}
...
\node (null1) [io,  right of=dec1, xshift=4.5cm] {Вывод:\\ значение не определено};
\node (call)  [process,  below of=dec1] {Для каждого season\_id: \\ \texttt{CALL update\_season\_stats(season\_id)}};
