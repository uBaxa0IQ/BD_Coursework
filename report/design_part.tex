...
\begin{tikzpicture}[
    ...
    store/.style={draw, thick, cylinder, shape border rotate=90,
      ...
      align=center},
    arrow/.style={draw=black, thick,->,>=stealth},
    label/.style={font=\footnotesize, text=black, midway}
]
...
% Labels
\node [font=\footnotesize\itshape, text=black] at (0, -1.8) {Уровень представления};
\node [font=\footnotesize\itshape, text=black] at (6, -1.8) {Уровень приложения};
\node [font=\footnotesize\itshape, text=black] at (12.5, -2.8) {Уровень данных};
\end{tikzpicture}
