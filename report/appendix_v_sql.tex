\section*{Приложение Б. Примеры SQL-запросов}
\addcontentsline{toc}{section}{Приложение Б. Примеры SQL-запросов}
...
WHERE pss.season_id = (SELECT season_id FROM seasons WHERE label = '2025-26')
  AND pss.per > (
      SELECT AVG(per)
      FROM player_season_stats
      WHERE season_id = (SELECT season_id FROM seasons WHERE label = '2025-26')
        AND per IS NOT NULL
  )
